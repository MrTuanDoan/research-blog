---
title: "My Chief of SEO, Claude Cowork - The Ultimate 20 Prompt System"
date: "2026-03-25"
author: "bloggersarvesh"
author_name: "Sarvesh Shrivastava"
source: "https://x.com/bloggersarvesh/status/2036795618090520592"
tweet_id: "2036795618090520592"
content_type: "prompt-system"
cot_approach: "implementation-plan"
stats:
  likes: 210
  retweets: 23
  views: 327063
...
tags:
  ...
  - x-article
  - bloggersarvesh
excerpt: "My Chief of SEO, Claude Cowork - The Ultimate 20 Prompt System"
---

![My Chief of SEO, Claude Cowork - The Ultimate 20 Prompt System](images/cover.jpg)

> **Source:** [Sarvesh Shrivastava (@bloggersarvesh)](https://x.com/bloggersarvesh) · [Original article](https://x.com/bloggersarvesh/status/2036795618090520592)

THIS IS THE ARTICLE I WASN'T GOING TO PUBLISH. Claude Cowork is now my Chief of SEO. i'm giving the exact prompts away for free.


![To get similar results for your business - apply at ALVENTRAMARKETING.COM](images/img-001.jpg)
*To get similar results for your business - apply at ALVENTRAMARKETING.COM*

i built a 20-part prompt system inside Claude Cowork that audits your entire Google presence, finds every gap your competitors are exploiting, and hands you a ranked execution plan. i'm walking you through all of it.

not surface level. the actual prompts. the thinking behind them. and why each one moves your rankings.

save this. you'll need it.

## **what it actually does**

before i open a single tab, Claude Cowork already knows my business. my service area. my competitors. my Google Business Profile. my review velocity. which categories i'm missing. which citations have the wrong phone number. all of it loaded in before i say a word.

when i sit down to work, i hit a prompt. each one does something that used to take hours.

by the time i've run the full stack, i have a complete picture of exactly where i stand on Google and exactly what to fix. not vague recommendations. a prioritized spreadsheet with specific actions, sorted by impact.

the first time i watched it pull competitor category data, map it against map pack rankings, and highlight every category i was missing - i just stared at the screen. that analysis alone used to take half a day per client.

now it takes minutes.


![shameless plug : Checkout my TEDx talk: https://youtu.be/2B79SIsRP0w?si=0DsXJi3X_jOf3xaD](images/img-002.jpg)
...
## **part 1: load your business context**

before you run a single prompt, Claude needs to know who you are.

this is the step 90% of people skip. it's also why 90% of people get generic output.

Example input prompt

open Claude Cowork and paste this in before you do anything else. fill in every bracket:

> "Here is everything you need to know about my business before we start any SEO work. Reference this every time I ask you to run an audit, build a strategy, or analyze competitors. Never ask me for this information again.  BUSINESS BASICS: Business name: [your business name] Address: [full address] Phone: [phone number] Website: [website URL] Google Business Profile: [GBP URL] Years in business: [X years]   
...
## **part 2: give Claude access to your SEO tools**

this is the 1 click that changes everything.

Claude Cowork runs through a Chrome extension. that means Claude can open any tab in your browser. including Ahrefs. including SEMrush. including Google Search Console.

your agency pays thousands per month for analysts to log into these tools and pull data manually. Claude does it in minutes.

here's how to set it up:

**step 1:** make sure you have the Claude Cowork Chrome extension installed and active.

**step 2:** log into Ahrefs or SEMrush in a Chrome tab. stay logged in. Claude can now access these tools in any session.

**step 3:** log into Google Search Console for your property. same thing - stay logged in.

that's it. that's the 1 click. you're already logged into these tools. you just never told Claude it could use them.

now every prompt can pull real data instead of guessing.
...
> *"Open Chrome and go to my GBP listing at [URL] and these competitors: [URL1], [URL2], [URL3]. For each listing, count: total photos, photos uploaded in the last 90 days, types of photos (team, jobs, before-after, office, trucks, equipment), and whether any look like stock photos. Put this in a spreadsheet comparing me vs each competitor.  *i built this system after 14 years of managing local SEO for home services businesses. plumbers. HVAC companies. lawyers. cleaning companies. i've seen what moves rankings and what wastes time.
...
shameless plug : Checkout my TEDx talk:[https://youtu.be/2B79SIsRP0w?si=0DsXJi3X_jOf3xaD](https://youtu.be/2B79SIsRP0w?si=0DsXJi3X_jOf3xaD)

> "Here is everything you need to know about my business before we start any SEO work. Reference this every time I ask you to run an audit, build a strategy, or analyze competitors. Never ask me for this information again.  BUSINESS BASICS: Business name: [your business name] Address: [full address] Phone: [phone number] Website: [website URL] Google Business Profile: [GBP URL] Years in business: [X years]   Team size: [solo / small team / large team]  SERVICES + MARKET: Primary service: [what you do]   Secondary services: [service 2], [service 3], [service 4]   Service areas: [city 1], [city 2], [city 3], [city 4], [city 5]   Target customer: [who your best customer is] Average job value: [$X]  SEO GOALS: 

Top 5 keywords I want to rank for: [keyword 1], [keyword 2], [keyword 3], [keyword 4], [keyword 5]   Keywords I currently rank for: [keyword 1], [keyword 2] Keywords I should rank for but don't: [keyword 1], [keyword 2]  CURRENT STANDINGS: Google reviews: [X] total, [X] star rating, [X] new reviews per month   GBP monthly views: [X impressions if known] Monthly website traffic: [X visits if known] Current map pack status: [ranking for X, not ranking for Y] Biggest SEO problem right now: [one sentence - be honest]  COMPETITORS: [competitor name] - [GBP URL] - [website] - [why they're beating you if you know] [competitor name] - [GBP URL] - [website] - [why they're beating you if you know] [competitor name] - [GBP URL] - [website] - [why they're beating you if you know]  WHAT I'VE ALREADY TRIED: [List any SEO work already done - agency, DIY, tools used, what worked, what didn't]  HOW I WANT YOU TO WORK: Always prioritize quick wins over long-term plays unless i ask otherwise.   When you give me a recommendation, tell me the impact level (high/medium/low) and how long it will take to see results. Always output data in spreadsheet format when comparing competitors. When you're unsure about something, tell me - don't guess. Never ask me for this information again. Use it as the base for everything we do together."
...
[ALVENTRAMARKETING.COM](https://alventramarketing.com/)
...
> "Open Chrome and go to my GBP listing at [URL] and these competitors: [URL1], [URL2], [URL3]. For each listing, analyze the last 30 review responses from the business owner. Extract:  Total reviews vs responses (calculate response rate %)  Average response time if estimable from dates  Whether responses mention specific services  Whether responses mention specific locations or neighborhoods  Average response length in words  Tone (formal/casual/personal)  

How negative reviews are handled - do they apologize, offer resolution, get defensive?  Any patterns in language that seem to perform well based on reply engagement  Put this in a spreadsheet comparing my response strategy vs competitors.  Then build me a complete review response template system:  3 variations for 5-star reviews that naturally include [service keyword] + [city keyword]  3 variations for 4-star reviews that acknowledge the slight gap and invite return  3 variations for 3-star reviews that take accountability and offer resolution  3 variations for 1-2 star reviews that are professional, empathetic, and defuse negativity without being defensive  Each template should be 40-80 words. Make them sound like a real person wrote them, not a robot."
...
![Check us out at ALVENTRAMARKETING.COM](images/img-003.jpg)
*Check us out at ALVENTRAMARKETING.COM*
