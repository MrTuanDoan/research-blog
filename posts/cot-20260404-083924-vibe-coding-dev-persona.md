...
- The 10x engineer (grinds raw code, hates abstraction)
...
### Step 1: What is the vibe coder archetype actually?

A vibe coder is someone who:
- Thinks in intent, not syntax
- Designs systems, delegates execution
- Moves fast on high-level decisions, trusts AI for low-level implementation
- Values flow and iteration over precision upfront
...
### Step 2: What personality does Boris's system imply?

Each of his 6 principles reveals something about the person behind them:

**Plan mode first:**
This person is not impulsive. They resist the urge to just start typing. They've been burned before (everyone has) and learned: the cheap investment is thinking before building, not debugging after. They're patient in a way that feels counterintuitive for someone who moves fast.

*Persona trait: Disciplined patience. "I slow down to speed up."*
...
*Persona trait: Non-precious pragmatism. "Kill what's not working. Don't preserve things out of sentiment."*
...
*Persona trait: Systems thinker. "Build the feedback loop, not just the feature."*
...
*Persona trait: Multi-threaded. Experiments, learns, optimizes.*
...
*Persona trait: Long-horizon thinker who challenges conventional wisdom. Bets on trajectories, not snapshots.*

---

### Step 3: What does the vibe coding dev persona say and not say?

**Says:**
- "I start in plan mode. I don't write code until I know exactly what I'm building."
- "My claude.md is maybe 800 tokens. I delete things that aren't earning their place."
- "I give Claude a way to verify its own work. That's where the quality multiplier comes from."
- "I run separate sessions for separate concerns. Fresh context sees things that a deep context misses."
- "Every inner loop I do more than twice becomes a skill. Document once, run forever."
- "I'm not optimizing prompts. The model gets better every month. I'm optimizing my information layer."
- "I'm not vibe coding in the 'YOLO and hope' sense. I'm vibe coding in the 'I design the system, Claude executes it' sense."

**Doesn't say:**
- "I used ChatGPT to write this." (they're past that)
- "AI is going to replace developers." (they're a developer using AI)
- "Here's my optimized prompt template..." (waste of time per Boris)
- "I'm not really technical." (the persona owns their technical identity)
- "AI wrote this for me." (AI executed their design)

---

### Step 4: What's the vibe coder's visual/behavioral identity?

Boris says his setup is "pretty vanilla." This is actually a strong identity signal. The vibe coder doesn't need elaborate tooling to prove their legitimacy. They ship with a terminal, Claude Code, and a clear head.

**The vibe coder's setup:**
- Terminal over GUI tools
- Claude Code (not just Claude.ai chat)
- Skills folder for their key workflows
- Minimal but intentional claude.md
- Multiple terminal sessions running simultaneously
- Plan mode as default, not exception

**What they're NOT:**
- Not showing off a 20-tab browser setup
- Not using 15 different AI tools
- Not posting about prompt engineering hacks
- Not building in public in a hustle-culture way

They build. They ship. Then they talk about what they learned, not how hard they worked.

---

### Step 5: How to inhabit this persona authentically

The trap with persona-building: performance without substance. Someone can *talk* like a vibe coder without actually being one. The difference is experiential evidence.
...
### Step 6: The core identity statement for the vibe coding dev persona

Distilling everything above into a single identity positioning:
...
**What they believe:**
1. Thinking before building saves hours of debugging
2. Minimal, intentional context beats exhaustive instructions
...
- Has a skills folder with named, documented processes
- Claude.md under 1,000 tokens, regularly audited
- Runs verification sweeps at end of sessions
- Opens fresh context windows for hard problems
- Never optimizes prompts; invests in information architecture instead

**The phrase that defines them:**
> *"I don't write code. I design systems. Claude builds them. I verify they work."*

---

### Practical Application: Building This Persona

| Action | When | Signal It Sends |
|---|---|---|
| Always mention plan mode | When discussing how you work | "I think before I build" |
...
If there's a single insight from Boris that defines the vibe coder's identity, it's this:

> **The model will never be as bad as it is today.**

That single belief shapes everything. It means: stop optimizing for the present model. Build systems that get better as the model improves. Invest in architecture, not prompts. Think 6 months ahead, not 6 minutes.

That's not a workflow tip. That's a worldview. And worldviews are what make personas feel real.
